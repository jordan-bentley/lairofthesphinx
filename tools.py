...
import pygame as pg
"""
Code pulled from pygame tutorial:
http://programarcadegames.com/python_examples/en/sprite_sheets/
"""

def load_all_gfx(directory, colorkey=None, accept=(".png")):
    """
...
sprites = split_sheet("player.png", (64, 55), 5, 5)
surface.blit(sprites[1], (450, 500))